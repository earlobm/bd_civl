...
class NacidoController extends Controller
{
    ...
    public function get_department_madre(Request $request){
    ...
    public function get_province_madre(Request $request){       
        $id=$request->id;
        $sqlx="SELECT *
    ...
    public function get_district_madre(Request $request){       
        $id=$request->id;
        $sqlx="SELECT *
    ...
    public function get_department_padre(Request $request){
        $sqlx="SELECT * FROM departament order by departamento";
        $datax=DB::select($sqlx);
          return [
              'datax'=>$datax,
    ...
    public function get_province_padre(Request $request){       
        $id=$request->id;
        $sqlx="SELECT *
          FROM province  where id_departmen=$id
         order by provincia";
    ...
    public function get_district_padre(Request $request){       
        $id=$request->id;
        $sqlx="SELECT *
          FROM distric  where idProv=$id
         order by distrito";
    ...
    public function saveNacido(Request $request){
        if($request->idperson==-1){
            $clasex = new Person();
        }else{
            $clasex = Person::findOrFail($request->idperson);
        }  
        ///Preguntamos si el nacido existe
        if($request->estado!=null || $request->estado!=''){
            if($request->idnacido==-1){
                $clase_nacido = new Nacido();
            }else{
                $clase_nacido = Nacido::findOrFail($request->idnacido);
                
            } 
            $clase_nacido->nacido_lugar = $request->nacido_lugar;
            $clase_nacido->estado = 1;
            $clase_nacido->id_persona = $request->id_persona;
            $clase_nacido->id_district = $request->id_district;
            $clase_nacido->name_madre =$request->name_madre;
            $clase_nacido->last_madre_paterno =$request->last_madre_paterno;
            $clase_nacido->last_madre_materno =$request->last_madre_materno;
            $clase_nacido->edad_madre =$request->edad_madre;
            $clase_nacido->estado_civil_madre =$request->estado_civil_madre;
            $clase_nacido->profesion_oficio_madre =$request->profesion_oficio_madre;
            $clase_nacido->number_doc_madre =$request->number_doc_madre;
            $clase_nacido->fecha_nacimiento_madre =$request->fecha_nacimiento_madre;
            $clase_nacido->name_departament_madre =$request->name_departament_madre;
            $clase_nacido->name_province_madre =$request->name_province_madre;
            $clase_nacido->name_distric_madre =$request->name_distric_madre;
            
            $clase_nacido->name_padre =$request->name_padre;
            $clase_nacido->last_padre_paterno =$request->last_padre_paterno;
            $clase_nacido->last_padre_materno =$request->last_padre_materno;
            $clase_nacido->edad_padre =$request->edad_padre;
            $clase_nacido->estado_civil_padre =$request->estado_civil_padre;
            $clase_nacido->profesion_oficio_padre =$request->profesion_oficio_padre;
            $clase_nacido->number_doc_padre =$request->number_doc_padre;
            $clase_nacido->fecha_nacimiento_padre =$request->fecha_nacimiento_padre;
            $clase_nacido->name_departament_padre =$request->name_departament_padre;
            $clase_nacido->name_province_padre =$request->name_province_padre;
            $clase_nacido->name_distric_padre =$request->name_distric_padre;
            $clase_nacido->save();
        }
        ...
        $clasex->save(); 
        /* $DateO$clasex->name_padre =$request->name_padre;
        $clasex->last_padre_paterno =$request->last_padre_paterno;
        $clasex->last_padre_materno =$request->last_padre_materno;
        $clasex->edad_padre =$request->edad_padre;
        $clasex->estado_civil_padre =$request->estado_civil_padre;
        $clasex->profesion_oficio_padre =$request->profesion_oficio_padre;
        $clasex->number_doc_padre =$request->number_doc_padre;
        $clasex->fecha_nacimiento_padre =$request->fecha_nacimiento_padre;
        $clasex->name_departament_padre =$request->name_departament_padre;
        $clasex->name_province_padre =$request->name_province_padre;
        $clasex->name_distric_padre =$request->name_distric_padre;fRequest= date("Y-m-d H:i:s");
            $clasex->modificado ='Modificado por '.Auth::user()->nick.' '. $DateOfRequest;*/
          return  $clasex->idnacido; 
        }
    ...
    public function save_data(Request $request){
        ...
        if($request->estado!=null || $request->estado!=''){
            ...
            $clasex->name_padre =$request->name_padre;
            $clasex->last_padre_paterno =$request->last_padre_paterno;
            $clasex->last_padre_materno =$request->last_padre_materno;
            $clasex->edad_padre =$request->edad_padre;
            $clasex->estado_civil_padre =$request->estado_civil_padre;
            ...
            $clasex->name_departament_padre =$request->name_departament_padre;
            $clasex->name_province_padre =$request->name_province_padre;
            $clasex->name_distric_padre =$request->name_distric_padre;
            $clase_nacido->save();
        }
