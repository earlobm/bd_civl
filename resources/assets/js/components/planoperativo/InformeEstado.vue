    ...
    <main class="main">
        <div class="box-header with-border">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-cubes"></i>Plan Operativo</a></li>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                               
                                        <div class="box-body"> 
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 15px;">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="input-group">
                                                                    ...
                                                                    <date-picker @dp-change="listenToChangeEvent()" v-model="year" :config="options" style="border-top-right-radius: 3px;border-bottom-right-radius: 3px;"></date-picker>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> -->
                                            ...
                                            <template v-if="listadoCab==1">                
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <legend style="font-size:18px;"><i class="fa fa-calendar"></i><strong> PLAN OPERATIVO:</strong>
                                                    ...
                                                    <div class="row" v-if="filter">
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal">
                                                                <label class="col-md-2 control-label">Objetivo Estratégico</label>
                                                                <div class="col-md-10">
                                                                    <div class="form-group">                                                            
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon" style="border-top-left-radius:3px;border-bottom-left-radius:3px"><i class="fa fa-sitemap"></i></span>
                                                                ...
                                                                <label class="col-md-2 control-label">Actividad estratégica</label>
                                                                <div class="col-md-10">
                                                                    <div class="form-group">                                                            
                                                                        <div class="input-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">                                                            
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select v-model="unit_txt" class="form-control select2" style="border-top-right-radius:3px;border-bottom-right-radius:3px" @change="onChangeActivityAllFilter($event.target.value)">
                                                                                <option selected="selected" value="" >Seleccione</option>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                                    <div class="box-body">                                        
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">   
                                                <legend style="font-size:16px;"><i class="fa fa-file"></i><strong> PEI</strong> <small>Plan Estratégico Institucional</small></legend>
                                            ...
                                            <div class="col-md-4">   
                                                <legend style="font-size:16px;"><i class="fa fa-database"></i><strong> Otros datos</strong> <small>MEF y unidades</small></legend>
                                                <div class="box box-widget widget-user-2">
                                                    <div class="box-footer no-padding" style="border-radius: 3px;">
                                                        <ul class="nav nav-stacked">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <!-- <div class="form-group">
                                                    <label  class="col-md-2 control-label">Unidadx</label>
                                                        ...
                                                        v-model="item"  style="font-size: 2rem;"
...
<script>
    ...
    export default {
        ...
        mounted() {
           this.onChangeDependency(this.year_txt);
        }
