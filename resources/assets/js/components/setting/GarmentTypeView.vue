        ...
        <div class="box-header with-border">
            <section class="content-header">
                <h3 class="box-title"><strong> 
                    TIPO PRODUCTO / FAMILIA PRODUCTO </strong>                            
                </h3>
            </section>
            <!--Hola-->
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
           <!-- general form elements -->
            ...
            <!-- form start -->
             <div class="box-header with-border">
              <h3 class="box-title">FAMILIA PRODUCTO</h3>
            </div>
            <div class="row">
               <div class="col-md-12">
                   <div v-bind:class="errorInputActivity3">
                            <label for="ap_paterno">Tipo Producto</label>
                            <div class="input-group">
                ...
                <div class="row">
                   ...
                   <div class="col-md-2">
                    <div >
                        <label for="nombres">Agregar:</label>
                        <div class="input-group">
                            <button type="submit" @click="addFamilyProduct()"  class="btn btn-mostrar btn-flat" style="border-top-right-radius:3px;border-bottom-right-radius:3px"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                   </div>
                </div>                                            
                                                                ...
                                                                <div class="box-body table-responsive no-padding">
                                                                    <table  class="table table-hover" style="font-size:12px">
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                <tr v-for="(midata,index) in listTypeProduct" :key="index" >
                                                                                    <td style="vertical-align: middle;" >{{(index+1)}}</td>
                                                                                    <td style="vertical-align: middle;" v-text="midata.name"></td>
                                                                                    <td style="vertical-align: middle;text-align: center;"> 
                                                                                        ...
                                                                                        <button title="Eliminar" type="button" @click="deleteDataFamily(midata.id)" class="btn btn-eliminar btn-sm">
                                                                                        <i class="fa fa-trash"></i>
                                                                                    </button>                                       
                                                                                    </td> 
