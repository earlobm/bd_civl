        ...
        <div class="box-header with-border">
            <section class="content-header">
                <h3 class="box-title"><strong> 
                    GESTION ROLES Y PERMISOS</strong>                            
                </h3>
                <ol class="breadcrumb">
                                                                ...
                                                                <tbody>
                                                                     <tr v-for="(midata,index) in listRol" :key="index" >
                                                                        ...
                                                                        <td style="vertical-align: middle;text-align: center;"> 
                                                                            <button title="Rol Permiso" type="button" @click="rolPermiso()" class="btn btn-eliminar btn-sm">
          ...
          <!-- general form elements -->
            ...
            <div class="box-header with-border">
                <div class="col-md-6" style="float:left;">
                    ...
                    <i class="fa  fa-chevron-circle-left" @click="volver()" style="float:left;"></i>&nbsp;
            ...
            <div class="row">
               <div class="col-md-10">
                    <div v-bind:class="errornameProductType">
                        <label for="nombres">PERMISOS ASIGNADOS AL CARGO</label>
                    </div>
               </div>
            ...
            <div class="row">     
               <div class="col-md-12">
                                                                <div class="box-body table-responsive no-padding">
                                                                    <table  class="table table-hover" style="font-size:12px">
                                                                        <thead style="background: #FFFFFF;color: #060006;">                                                                                   
                                                                            <tr>
                                                                                <th style="vertical-align: middle;">#</th>
                                                                                <th style="vertical-align: middle;">Modulo</th>
                                                                                <th colspan="2" style="text-align: center; vertical-align: middle;">Eliminar</th>
                                                                            </tr> 
                                                                        </thead>
                                                                        <tbody>
                                                                                
                                                                                <tr v-for="(midata,index) in listPermisosSi" :key="index" >
                                                                                    <td style="vertical-align: middle;background: #FFFFFF" >{{(index+1)}}</td>
                                                                                    <td style="vertical-align: middle;background: #FFFFFF" v-text="midata.name"></td>
                                                                                    <td style="vertical-align: middle;text-align: center;background: #FFFFFF"> 
         ...
         <div class="col-md-6">
           <!-- general form elements -->
            ...
            <div class="row">
                ...
                <div class="row">
                   <div class="col-md-10">
                                                                <div v-bind:class="errorInputName">
                                                                    <label for="nombres">PERMISOS NO ASIGNADOS AL CARGO:</label>
                                                                </div>
                   </div> 
                </div>                                            
                                                                    ...
                                                                    <table  class="table table-hover" style="font-size:12px">
                                                                        <thead style="background: #FFFFFF;color: #060006;">                                                                                   
                                                                            <tr>
                                                                                <th style="vertical-align: middle;">#</th>
                                                                                <th style="vertical-align: middle;">Modulo</th>
                                                                                <th style="text-align: center; vertical-align: middle;">Agregar</th>
                                                                            </tr> 
                                                                        </thead>
                                                                        <tbody>
                                                                                
                                                                                <tr v-for="(midata,index) in listPermisosNo" :key="index" >
                                                                                    <td style="vertical-align: middle;background: #FFFFFF" >{{(index+1)}}</td>
                                                                                    <td style="vertical-align: middle;background: #FFFFFF" v-text="midata.name"></td>
                                                                                    <td style="vertical-align: middle;text-align: center;background: #FFFFFF"> 
                                                                                        <button type="button" @click="editarfamilyProduct(midata.id)" class="btn btn-editar btn-sm">
    ...
    export default {
        ...
        methods : { 
            ...
            listarPermisos(){
                let me=this;  
                //me.listado=2;             
                var url= 'getListPermission';
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.listPermisosNo=respuesta.datax;
                   me.listado=2;
