                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="box-body table-responsive no-padding">
                                                            <table  class="table table-hover" style="font-size:12px">
                                                                ...
                                                                <tbody>
                                                                     <tr v-for="(midata,index) in listEjesEstrategico" :key="index" >
                                                                        ...
                                                                        <td style="vertical-align: middle;text-align: center;"> 
                                                                            <button type="button" @click="editar(midata.id_strategic_axis)" class="btn btn-editar btn-sm">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>    
                                                                            <button title="Eliminar" type="button" @click="eliminar(midata.id_strategic_axis)" class="btn btn-eliminar btn-sm">
                                               ...
                                               <div class="col-md-12">
                                                <div class="form-horizontal" style="margin-top: 15px">                                                    
                                                    ...
                                                    <div v-bind:class="errorInputActivity1" >
                                                        ...
                                                        <div class="col-md-11">
                                                            <div class="input-group">
                                                                <span class="input-group-addon" style="border-top-left-radius:3px;border-bottom-left-radius:3px"><i class="fa fa-exchange"></i></span>
    ...
    export default {
        ...
        methods : { 
            ...
            editar(id){
                ...
                me.limpiar();
                // this.nombre= '';
                var url= 'get_ejesestrategico?id_strategic_axis='+id;
				axios.get(url).then(function (response) {
					var respuesta= response.data;
                    me.name=respuesta.datax[0].name;
                    me.code=respuesta.datax[0].code;
                    me.id=respuesta.datax[0].id_strategic_axis;
            ...
            guardar(){
                ...
                let me = this;
                axios.post('save_EjesEstrategico',{
            ...
            listar(){
                let me=this;              
                var url= 'get_ejesestrategico?buscar='+me.buscar;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.listEjesEstrategico=respuesta.datax;
