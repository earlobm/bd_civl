        ...
        <div class="box-header with-border">
            <section class="content-header">
                <h3 class="box-title"><strong> 
                    ACTIVIDADES ESTRATÉGICAS</strong>                            
                </h3>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-database"></i>Registros</a></li>
                    <li><a href="#">PEI</a></li>
                    <li class="active">Actividades Estratégicas</li>
                </ol>
            </section>
            <!--Hola-->
                                                    ...
                                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-5">
                                                        <div class="btn-group" style="float:right; margin-left: 10px;">   
                                                            <button type="button" @click="agregar(year)" class="btn btn-add">
                                                                <i class="fa fa-plus"></i>&nbsp;Agregar actividad estr.
                                                            </button>
                                                        </div>
                                                            ...
                                                            <table  class="table table-hover" style="font-size:12px">
                                                                <thead style="background: #90a4ae;color: #fff;">                                                                                   <tr>
                                                                      <tr>    
                                                                        ...
                                                                        <th style="vertical-align: middle;">OBJETIVOS ESTRATEGICOS</th>
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(midata,index) in list_strategic_activity" :key="index" >
                                                                        <td style="vertical-align: middle;" >{{(index+1)}}</td>
                                                                        <td style="vertical-align: middle;" v-text="midata.goal_strategic"></td>
                                                                        <td style="vertical-align: middle;" v-text="midata.code"></td>
                                                                        <td style="vertical-align: middle;" v-text="midata.name"></td>
                                                                        <td style="vertical-align: middle;text-align: center;"> 
                                                                            <button type="button" @click="editar(midata.id_strategic_activity)" class="btn btn-editar btn-sm">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>   
                                                                            <button title="Eliminar" type="button" @click="eliminar(midata.id_strategic_activity)" class="btn btn-eliminar btn-sm">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-horizontal" style="margin-top: 15px">                                                   
                                                            <div v-bind:class="errorInputActivity" >
                                                                <label  class="col-md-2 control-label">Objetivos Estratégicos</label>
                                                                <div class="col-md-10">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <select v-model="idGoal" class="form-control select2" style="border-top-right-radius:3px;border-bottom-right-radius:3px">
                                                                            <option selected="selected" value="" >Seleccione</option>
                                                                            <option v-for="goal in arraygoal" :key="goal.id_strategic_goal" :value="goal.id_strategic_goal">{{ goal.code }}|| {{ goal.name }}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div v-bind:class="errorInputActivity1" >
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon" style="border-top-left-radius:3px;border-bottom-left-radius:3px"><i class="fa fa-rocket"></i></span>
                                                            ...
                                                            <div v-bind:class="errorInputActivity1" >
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon" style="border-top-left-radius:3px;border-bottom-left-radius:3px"><i class="fa fa-money"></i></span>
                                                                        <select v-model="idActivi" class="form-control select2" style="border-top-right-radius:3px;border-bottom-right-radius:3px">
                                                                            <option selected="selected" value="" >Seleccione</option>
                                                                            <option v-for="activi in arrayactivi" :key="activi.id_activity" :value="activi.id_activity">{{ activi.code }}|| {{ activi.name }}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>      
                                                            </div>      
