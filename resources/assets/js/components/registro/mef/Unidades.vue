                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="box-body table-responsive no-padding">
                                                            <table  class="table table-hover" style="font-size:12px">
                                                                ...
                                                                <tbody>
                                                                	<tr v-for="(midata,index) in listUnit" :key="index" >
                                                                        ...
                                                                        <td style="vertical-align: middle;text-align: center;"> 
                                                                            <button type="button" @click="editar(midata.id_unit)" class="btn btn-editar btn-sm" data-toggle="tooltip" title="Editar">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>      
                                                                            <button title="Eliminar" type="button" @click="eliminar(midata.id_unit)" class="btn btn-eliminar btn-sm" data-toggle="tooltip">
...
<script>
    ...
    export default {
        ...
        methods : { 
            ...
            listar(){
                let me=this;              
                var url= 'get_unit?buscar='+me.buscar;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
